...
[Keyless]
public partial class vRemitoTotalComisiones
{
    [StringLength(31)]
    [Unicode(false)]
    ...
    [Column("Price ARS", TypeName = "decimal(18, 4)")]
    public decimal? Price_ARS { get; set; }

    [Column("Price USD OF", TypeName = "decimal(18, 4)")]
    public decimal? Price_USD_OF { get; set; }

    [Column("Price USD BLUE", TypeName = "decimal(18, 4)")]
    public decimal? Price_USD_BLUE { get; set; }

    [Column(TypeName = "decimal(5, 2)")]
    public decimal? CommisionPercent { get; set; }

    [Column(TypeName = "decimal(18, 2)")]
    public decimal? CurrencyRateUnified { get; set; }

    [Column(TypeName = "decimal(18, 2)")]
    public decimal? USDAVG { get; set; }

    [Column("Price USD AVG", TypeName = "decimal(38, 6)")]
    public decimal? Price_USD_AVG { get; set; }

    [Column("Total USD AVG", TypeName = "decimal(38, 6)")]
    public decimal? Total_USD_AVG { get; set; }
}
